...
class DashController extends Controller
{
    ...
    public function index()
    {
        ...
        $sedia_total = $jual_total - $beli_total;
        $this->data['sedia_harga'] = $sedia_harga;
        $this->data['sedia_jum'] = $sedia_jum;
        $this->data['sedia_total'] = $sedia_total;

        //Data terakhir update
        $update_date_beli = Pembelian::max('tanggal');
        $update_date_jual = Penjualan::max('tanggal');
        $this->data['update_date_beli'] = $update_date_beli;
        $this->data['update_date_jual'] = $update_date_jual;
