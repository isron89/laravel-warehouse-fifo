...
<head>
    ...
    <!-- CSS -->
    <link href="{{ asset('assets') }}/auth/css/white-dashboard.css?v=1.0.0" rel="stylesheet" />
    <link href="{{ asset('assets') }}/auth/css/theme.css" rel="stylesheet" />
</head>
...
<body class="white-content {{ $class ?? '' }}">
    ...
    <script src="{{ asset('assets') }}/auth/js/white-dashboard.min.js?v=1.0.0"></script>
